...
| `pdf` | PDF 页面整理 | PDF 页面加载、追加合并、删除、旋转、排序、导出 |
...
阶段 1 交付名：`PDF 页面整理`，能力为加载、追加合并、删除、旋转、排序、导出。
...
1. User sidebar 只出现：个人首页、我的云盘、文件转换、PDF 页面整理。
